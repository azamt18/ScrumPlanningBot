...
using ScrumPlanningBot.API.Commands;
...
namespace ScrumPlanningBot.API
{
    public class Bot : IHostedService
    {
        ...
        private readonly ILogger<Application.Bot> _logger;
        private readonly UserService _userService; 
        public const string UnknownCommandMessage = "Unknown command. Try /help for a list of available commands.";

        public Bot(IChatService chatService, IServiceProvider serviceProvider, ILogger<Application.Bot> logger)
        {
        ...
        private async void OnChatMessage(object? sender, ChatMessageEventArgs chatMessageArgs)
        {
            try
            {
                _userService.AddUserByChat(chatMessageArgs.UserId);
